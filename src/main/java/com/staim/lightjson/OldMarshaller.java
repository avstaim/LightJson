...
class OldMarshaller {
    static JsonElement marshal(Object object) throws JsonException {
        ...
        JsonElement jsonElement = new ElementImpl(JsonType.OBJECT);
            ...
            for (Field field : aClass.getDeclaredFields()) {
                ...
                if (type != null) {
                    ...
                    if (field.get(object) == null) {
                        jsonElement.add(name, new ElementImpl(JsonType.NULL));
                        continue;
                    }
                    ...
                    switch (type) {
                        ...
                        case DATE:
                            ...
                            break;
                        case NULL:
                            jsonElement.add(jsonName, new ElementImpl(JsonType.NULL));
                            break;
                        case RAW:
                            if (ElementImpl.class.isAssignableFrom(fieldType)) {
    ...
    private static JsonElement processCollection(Collection collection) throws JsonException {
        JsonElement jsonElement = new ElementImpl(JsonType.ARRAY);
